...
//        }
        ...
        try (FileOutputStream fos = new FileOutputStream("C:\\YourJavaDirectory\\portfolio.ser");
        ...
        try (FileInputStream fis = new FileInputStream("C:\\YourJavaDirectory\\portfolio.ser");
